...
// const item_img = document.getElementsByClassName('image') ;
// console.log(item_img) ; 
// for(let i = 0; i < items.length; i++) {
//     items[i].addEventListener('mouseover', () => {
//         if(items[i].getAttribute('data-display') === 'false') {
//             items[i].style.transform = 'scale(1.5)' ;
//             items[i].style.zIndex = '99999';
//             items[i].setAttribute('data-display', 'true') ;
//             items[i].addEventListener('mouseleave', () => {
//                 items[i].style.transform = 'scale(1)' ;
//                 items[i].style.zIndex = '-999';
//                 items[i].setAttribute('data-display', 'false') ;
//             });
//         } 
//     })
// }
